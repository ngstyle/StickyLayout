...
//			updateSelection(positionOffset > 0.5f ? position + 1:position);
	...
	private int currentSeletedPosition = -1;
	...
	public <T extends View> T getIndicatorChildAtIndex(int position){
		if (position >= tabCount) {
			throw new IllegalStateException("tab index out of Bounds");
		}
		return (T) ((LinearLayout) getChildAt(0)).getChildAt(position);
	}
